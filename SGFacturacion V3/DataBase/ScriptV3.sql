...
(
	...
	RazonComercial		char (35)				NOT NULL,
	Telefono			char (35)				NOT NULL,
	Direccion			char (100)				NOT NULL,
	Correo				char (50)				NULL,
    CONSTRAINT Proveedor_IDProveedor_PK PRIMARY KEY CLUSTERED ( ID_Proveedor ASC ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
    CONSTRAINT Persona_Ruc_UQ UNIQUE NONCLUSTERED (Ruc ASC ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
BEGIN
	BEGIN TRY
    INSERT INTO Proveedor (Ruc, RazonComercial, Telefono, Direccion, Correo)
    VALUES (@Ruc, @RazonComercial, @Telefono, @Direccion, @Correo);
	END TRY
	BEGIN CATCH
...
BEGIN
	BEGIN TRY	
    UPDATE Proveedor 
    SET Ruc = @Ruc, RazonComercial = @RazonComercial, Telefono = @Telefono, Direccion = @Direccion, Correo = @Correo
...
END
GO
CREATE PROCEDURE Sp_Listado_Proveedor
AS
BEGIN
    SELECT ID_Proveedor as ID, Ruc, RazonComercial, Telefono, Direccion, Correo
    FROM Proveedor;
END
GO
...
BEGIN
    SELECT ID_Proveedor as ID, Ruc, RazonComercial, Telefono, Direccion, Correo
    FROM Proveedor
    WHERE (Ruc LIKE '%' + @Busqueda + '%' OR RazonComercial LIKE '%' + @Busqueda + '%');
END
GO
...
BEGIN
	BEGIN TRY	
		INSERT INTO PRODUCTO (Nombre,Precio_unitario,Stock,ID_Proveedor) VALUES (@Nombre, @precio_unitario, @stock, @ID_Proveedor);
	END TRY
	BEGIN CATCH
		PRINT 'Error ' + ERROR_MESSAGE();
	END CATCH
...
GO
-----------------------------------------------
---------Execute Sp InserT Proveedor
-----------------------------------------------
EXEC Sp_Insert_Proveedor '1790012345678', 'CocaCola', '02-2999999', 'Av. Principal 123, Quito', 'info@cocacola.com'
EXEC Sp_Insert_Proveedor '1798765432109', 'Pepsi', '02-2888888', 'Av. Secundaria 456, Guayaquil', 'contacto@pepsi.com'
EXEC Sp_Insert_Proveedor '1791234567890', 'Tony', '07-2777777', 'Calle Falsa 789, Cuenca', 'ventas@tony.com'
EXEC Sp_Insert_Proveedor '1790987654321', 'Danec', '04-2666666', 'Parque Industrial 101, Duran', 'soporte@danec.com'
EXEC Sp_Insert_Proveedor '1791357924680', 'Maggi', '03-2555555', 'Zona Industrial 654, Ambato', 'help@maggi.com'
Go
...
-----------------------------------------------
EXEC Sp_Insert_Producto 'Caf  de Loja', 8.5000, 2000,1
EXEC Sp_Insert_Producto 'Chocolate Pacari', 4.7500, 2000,2
EXEC Sp_Insert_Producto 'Banano', 0.1500, 2000,3
EXEC Sp_Insert_Producto 'Rosas de Cayambe', 1.5000, 2000,4
EXEC Sp_Insert_Producto 'Camar n de Manab ', 15.0000, 2000,5
EXEC Sp_Insert_Producto 'Helado de Salcedo', 2.5000, 2000,1
EXEC Sp_Insert_Producto 'Queso de Hoja', 3.8000, 2000,2
EXEC Sp_Insert_Producto 'Pan de Yuca', 1.2000, 2000,3
EXEC Sp_Insert_Producto 'Manjar de Leche', 3.0000, 2000,4
EXEC Sp_Insert_Producto 'Chifles', 0.7500, 2000,5
EXEC Sp_Insert_Producto 'Chocolates Kallari', 6.5000, 2000,1
EXEC Sp_Insert_Producto 'Tuna de Gal pagos', 2.0000, 2000,2
EXEC Sp_Insert_Producto 'Miel de Abeja', 5.0000, 2000,3
EXEC Sp_Insert_Producto 'Choclo', 0.5000, 2000,4
EXEC Sp_Insert_Producto 'Mote', 1.0000, 2000,5
EXEC Sp_Insert_Producto 'At n enlatado', 2.2500, 2000,1
EXEC Sp_Insert_Producto 'Caf  de Gal pagos', 10.0000, 2000,2
EXEC Sp_Insert_Producto 'Cacao Fino de Aroma', 12.0000, 2000,3
EXEC Sp_Insert_Producto 'Aguardiente Zhumir', 6.7500, 2000,4
EXEC Sp_Insert_Producto 'Pan de Ambato', 1.5000, 2000,5
EXEC Sp_Insert_Producto 'Fruta deshidratada', 3.7500, 2000,1
EXEC Sp_Insert_Producto 'Quinua', 2.5000, 2000,2
EXEC Sp_Insert_Producto 'Arroz de Daule', 1.0000, 2000,3
EXEC Sp_Insert_Producto 'Camarones enlatados', 8.0000, 2000,4
EXEC Sp_Insert_Producto 'Moras de los Andes', 4.0000, 2000,5
EXEC Sp_Insert_Producto 'Aj  de Man ', 3.2000, 2000,1
EXEC Sp_Insert_Producto 'Galletas Amor', 1.7500, 2000,2
EXEC Sp_Insert_Producto 'Refresco Pony Malta', 1.0000, 2000,3
EXEC Sp_Insert_Producto 'N ctar de Guayaba', 2.5000, 2000,4
EXEC Sp_Insert_Producto 'Dulce de Higos', 3.5000, 2000,5
EXEC Sp_Insert_Producto 'Alfajores de Man ', 2.0000, 2000,1
EXEC Sp_Insert_Producto 'Jugo de Naranja', 1.5000, 2000,2
EXEC Sp_Insert_Producto 'Chicha de Jora', 3.0000, 2000,3
EXEC Sp_Insert_Producto 'Licor de Ca a', 5.0000, 2000,4
EXEC Sp_Insert_Producto 'Salsa de Ajo', 1.7500, 2000,5
EXEC Sp_Insert_Producto 'Cerveza Club', 1.2500, 2000,1
EXEC Sp_Insert_Producto 'Turr n de Man ', 2.7500, 2000,2
EXEC Sp_Insert_Producto 'Galletas Ducales', 1.5000, 2000,3
EXEC Sp_Insert_Producto 'Granola de Quinua', 4.5000, 2000,4
EXEC Sp_Insert_Producto 'Pan de El Oro', 1.2500, 2000,5
EXEC Sp_Insert_Producto 'Bizcochos de Cayambe', 2.5000, 2000,1
EXEC Sp_Insert_Producto 'Ma z Tostado', 1.0000, 2000,2
EXEC Sp_Insert_Producto 'Papas Chauchas', 0.8000, 2000,3
EXEC Sp_Insert_Producto 'Mermelada de Mora', 3.2000, 2000,4
EXEC Sp_Insert_Producto 'Enlatado de Vegetales', 2.7500, 2000,5
EXEC Sp_Insert_Producto 'Juguete de Ferreter a', 12.0000, 2000,1
EXEC Sp_Insert_Producto 'Tornillos de Acero', 0.5000, 2000,2
EXEC Sp_Insert_Producto 'Martillo', 5.0000, 2000,3
EXEC Sp_Insert_Producto 'Llave Inglesa', 7.5000, 2000,4
EXEC Sp_Insert_Producto 'Alicate', 3.7500, 2000,5
EXEC Sp_Insert_Producto 'Cinta M trica', 2.5000, 2000,1
EXEC Sp_Insert_Producto 'Destornillador', 2.0000, 2000,2
EXEC Sp_Insert_Producto 'Sierra Manual', 4.5000, 2000,3
Go
